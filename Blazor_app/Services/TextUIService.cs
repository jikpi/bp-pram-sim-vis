namespace Blazor_app.Services
{
    ...
    public class TextUIService
    {
        ...
        public static string ExecutionResetTooltip { get; private set; } = "Reset the machine, without clearing memory. Use the stash functionality to perform state resets.";
        ...
        public static string StateIndicatorMachineSavedForReimport { get; private set; } = "Machine stashed.";
        ...
        public static Dictionary<string, string> CreateMachineExampleDictionary()
        {
            Dictionary<string, string> ExampleMachines = new Dictionary<string, string>
            {
                ...
                { "Calculate array of conjunctions in O(1)", "MACHINECODE\r\n# Calculate array of conjunctions\r\n# CRCW common\r\n# Outputs 1 if all is 1\r\n# Outputs 0 if any is not 1\r\n\r\n# Input\r\n# Size of array (n) at S1\r\n# S2 to Sn are array values\r\n# Value: 1 = true, \r\n# other = false\r\nS0 := 1\r\n\r\npardo S1\r\nL0 := {i}\r\nL0 := L0 + 2\r\nL1 := S{L0}\r\nif (L1 == 1) goto :not\r\nS0 := 0\r\n:not\r\nhalt\r\nparend\r\n\r\nWRITE(S0)\r\nhalt\r\nMEMORYINPUT\r\nMEMORYSHARED\r\n0:1\r\n1:5\r\n2:1\r\n3:1\r\n4:1\r\n5:1\r\n6:1\r\n" },
                { "Calculate array of disjunctions in O(1)", "MACHINECODE\r\n# Calculate array of disjunctions\r\n# in O(1)\r\n# CRCW common\r\n# Outputs 1 if any is 1\r\n# Outputs 0 if all are 0\r\n\r\n# Input:\r\n# Size of array (n) at S1\r\n# S2 to Sn are array values\r\n# Value: 1 = true, \r\n# other = false\r\nS0 := 0\r\n\r\npardo S1\r\nL0 := {i}\r\nL0 := L0 + 2\r\nL1 := S{L0}\r\nif (L1 == 1) goto :yes\r\ngoto :end\r\n:yes\r\nS0 := 1\r\n:end\r\nhalt\r\nparend\r\n\r\nWRITE(S0)\r\nhalt\r\n\r\nMEMORYINPUT\r\nMEMORYSHARED\r\n0:1\r\n1:5\r\n2:0\r\n3:0\r\n4:0\r\n5:0\r\n6:1\r\n" },
